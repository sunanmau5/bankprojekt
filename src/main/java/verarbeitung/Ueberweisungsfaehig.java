...
/**
 * Dieses Interface zeigt an, dass mit einem implementierenden Konto
 * �berweisungen durchgef�hrt werden k�nnen
 * 
...
public interface Ueberweisungsfaehig {
	/**
	 * bucht den angegebenen Betrag von this als �berweisung ab, falls es nicht
	 * gesperrt ist und alle kontospezifischen Regeln f�r die �berweisung
	 * eingehalten werden. Am Empf�ngerkonto wird keine �nderung vorgenommen, da
	 * davon ausgegangen wird, dass dieses sich bei einer anderen Bank befindet.
	 * 
	 * @param betrag           double
	 ...
	 * @return boolean true, wenn die �berweisungsabbuchung ausgef�hrt wurde, false,
	 *         wenn nicht (weil kontospezifische Regeln verletzt wurden, z.B.
